...
// configuration step. It creates a namespace called `MyDataStructure`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MyDataStructure::cmake::project_name, MyDataStructure::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MyDataStructure::cmake::project_version);
      return EXIT_SUCCESS;
    }
